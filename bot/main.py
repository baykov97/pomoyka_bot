...
magic_8_ball_responses = [
    ...
    "Мой ответ — нет", "Мои источники говорят нет", "Перспективы не очень хорошие", "Очень сомнительно", "Похуй",
    "А может похуй?", "Бля, отъебись", "Иди ка ты нахуй с такими вопросами", "Да я хуй знает, если честно",
    "А тебя это ебать не должно", "Ой блять, спроси че поумнее"
]
